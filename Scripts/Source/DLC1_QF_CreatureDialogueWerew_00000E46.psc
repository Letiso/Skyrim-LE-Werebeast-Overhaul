...
;BEGIN CODE
; Player picks indomitable rage 3 perk
...
;BEGIN CODE
; Player picks indomitable rage 1 perk

Game.IncrementStat("NumWerewolfPerks")

Game.UnlockWord(WO_HowlIndomitableRage)
Game.GetPlayer().AddShout(WO_HowlWerewolfIndomitableRage)

WO_IndomitableRageGainMessage.Show()
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
; Player picks indomitable rage 2 perk
...
Spell Property WO_SecondBreath Auto
...
Message Property WO_IndomitableRageGainMessage Auto
...
GlobalVariable Property WO_WerewolfSlayerPerk Auto
