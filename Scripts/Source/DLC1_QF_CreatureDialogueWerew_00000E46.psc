...
Game.GetPlayer().AddSpell(WO_PerkMoonlight3, false)
Game.GetPlayer().AddSpell(WO_PerkMoonlight4, false)

Game.GetPlayer().RemoveSpell(WO_PerkMoonlight1)
Game.GetPlayer().RemoveSpell(WO_PerkMoonlight2)
;END CODE
EndFunction
;END FRAGMENT
...
Game.GetPlayer().AddSpell(WO_PerkAdrenaline1)
Game.GetPlayer().AddSpell(WO_PerkAdrenaline2)
;END CODE
EndFunction
;END FRAGMENT
...
Spell Property WO_PerkMoonlight3 Auto
Spell Property WO_PerkMoonlight4 Auto
